...
h = 7; % two sensors are under attack.
...
% simulation part
run = 1; % the number of simulations
...
erro_IJAM(counter) = mean_attack_support_error_IJAM(last_non_zero_IJAM)
% error_my_ISTA(counter) = mean_attack_support_error_my_ISTA(last_non_zero_my_ISTA)
error_ISTA(counter) = mean_attack_support_error_ISTA(last_non_zero_ISTA)

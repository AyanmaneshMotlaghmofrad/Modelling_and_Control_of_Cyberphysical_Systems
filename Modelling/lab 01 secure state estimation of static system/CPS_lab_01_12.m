...
% simulation part
run = 10; % the number of simulations
...
error_IJAM(counter) = mean_attack_support_error_IJAM(end)
% error_my_ISTA(counter) = mean_attack_support_error_my_ISTA(last_non_zero_my_ISTA)
error_ISTA(counter) = mean_attack_support_error_ISTA(end)


my_IJAM_precision_vs_IJAM = (mean_state_estimation_error_IJAM(end)-mean_state_estimation_error_my_IJAM(end))...
                        /mean_state_estimation_error_IJAM(end)*100
my_ISTA_precision_vs_ISTA = (mean_state_estimation_error_ISTA(end)-mean_state_estimation_error_my_ISTA(end))...
                        /mean_state_estimation_error_ISTA(end)*100
counter = counter +1;
...
bar_handle = bar(1:8, mean_iterations, 'grouped');
...
title('Mean Attak Support Error Vs. number of attacks')
